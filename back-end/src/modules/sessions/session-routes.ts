...
const sessionRoutes: FastifyPluginAsync = async (app) => {
  ...
  app.post("/:attemptId/start", async (request, reply) => {
  ...
  app.get("/:attemptId/state", async (request, reply) => {
    const { attemptId } = request.params as { attemptId: string };
  ...
  app.post("/:attemptId/answers", async (request, reply) => {
    const { attemptId } = request.params as { attemptId: string };
  ...
  app.post("/:attemptId/answers/batch", async (request, reply) => {
    const { attemptId } = request.params as { attemptId: string };
  ...
  app.post("/:attemptId/pause", async (request, reply) => {
    const { attemptId } = request.params as { attemptId: string };
  ...
  app.post("/:attemptId/resume", async (request, reply) => {
    const { attemptId } = request.params as { attemptId: string };
  ...
  app.post("/:attemptId/terminate", async (request, reply) => {
    const { attemptId } = request.params as { attemptId: string };
  ...
  app.post("/:attemptId/events", async (request, reply) => {
    const { attemptId } = request.params as { attemptId: string };
  ...
  app.post("/:attemptId/violations", async (request, reply) => {
    const { attemptId } = request.params as { attemptId: string };
